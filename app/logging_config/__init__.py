...
def before_request_logging():
    ...
    log.info(f"Bank activated at {datetime.datetime.now()}")
...
def after_request_logging(response):
    ...
    log = logging.getLogger("myApp")
    log.info(f"Bank Logger activated at {datetime.datetime.now()}")

    log = logging.getLogger("request")
    log.info(f"Request Logger activated at {datetime.datetime.now()}")

    log = logging.getLogger("random")
    log.debug(f"Random Logger activated at {datetime.datetime.now()}")
